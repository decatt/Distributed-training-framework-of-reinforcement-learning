...
class Worker:
    def __init__(self, agent: agent_model.MobaAgent, batch_size: int, optimizer, use_gpu: bool, identity: int, version: int, queue_length=10000):
    ...
    def process_function(self):
        ...
        while update < 100:
            try:
                ...
                new_log_prob, entropy, new_values = self.agent.get_log_prob_entropy_value(states, action=actions.T, masks=masks)
